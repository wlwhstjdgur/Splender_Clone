...
Create and set up a Custom Function node to execute an HLSL function specified as a string or as an HLSL include file.
...
## Use shared data and existing Unity functions

Pass shared data into your custom function through uniform variables, and call functions from Unity's Render Pipeline shader libraries.
...
- [Custom Function node reference](Custom-Function-Node.md)
