    ...
    class SearcherControl : VisualElement
    {
        ...
        public SearcherControl()
        {
            ...
            if (m_ListView != null)
            {
                ...
                m_ListView.itemsChosen += obj => OnListViewSelect((SearcherItem)obj.FirstOrDefault());
                m_ListView.selectionChanged += selectedItems => m_Searcher.Adapter.OnSelectionChanged(selectedItems.OfType<SearcherItem>().ToList());
