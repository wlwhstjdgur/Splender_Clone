...
namespace Microsoft.Msagl.DebugHelpers.Persistence
{
    ...
    internal class GeometryGraphWriter
    {
        ...
        internal bool NeedToCloseXmlWriter
        {
        ...
        internal Dictionary<Node, string> NodeToIds
        {
            get { return nodeIds; }
            set { nodeIds = value; }
        }
        ...
        /// </summary>
        internal IEnumerable<Edge> EdgeEnumeration
        {
