...
namespace Microsoft.Msagl.Prototype.NonOverlappingBoundaries {
    ...
    /// </summary>
    internal abstract class CvxHull : IHull {
        /// <summary>
    ...
    /// </summary>
    internal class ClusterConvexHull : CvxHull {
    ...
    /// </summary>
    internal class AllPairsNonOverlappingBoundaries : IConstraint {
