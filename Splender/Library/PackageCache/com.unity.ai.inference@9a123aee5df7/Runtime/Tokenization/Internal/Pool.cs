...
namespace Unity.InferenceEngine.Tokenization
{
    ...
    partial class Pool<T> : IDisposable where T : class
    {
        ...
        /// </summary>
        /// <param name="create">
        /// The lambda function called to generate a brand new instance of <typeparamref name="T" />.
        /// </param>
        /// <param name="release">
        ...
        /// </exception>
        public Pool([NotNull] Func<T> create, [CanBeNull] Action<T> release = null)
        {
            m_Cache = new Stack<T>();
        ...
        /// When released, the <c>release</c> lambda function specified in the constructor will be
