...
namespace Unity.InferenceEngine.Tokenization.PostProcessors.Templating
{
    ...
    public class Template
    {
        ...
        /// <paramref name="repr" /> at the specified <paramref name="offset" /> doesn't match with
        /// a <see cref="int" /> representation.
        /// </exception>
        ...
        /// reach the end of the <see cref="string" /> representation of a <see cref="Sequence" />.
        /// </exception>
