...
namespace Unity.InferenceEngine.Tokenization.Mappers
{
    partial class BpeMapper
    {
            ...
            : IOneToOneConverter<(SubString character, bool first, bool last), string>
        {
            ...
            /// <summary>
            /// String appended to a token value representing a piece of a word while being at the
            /// end of it.
            /// </summary>
            ...
            /// String prepended to a token value representing a piece of a word while not being at
            /// the beginning of it.
            /// </param>
            ...
            /// <summary>
            /// Gets the token value of a <paramref name="character" /> considering its position in
            /// the word.
            /// </summary>
            ...
            /// </param>
            /// <returns>
            /// The token value of the <paramref name="character" /> considering its position in the
            /// word.
            /// </returns>
