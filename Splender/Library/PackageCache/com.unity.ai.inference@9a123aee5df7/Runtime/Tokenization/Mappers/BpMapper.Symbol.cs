namespace Unity.InferenceEngine.Tokenization.Mappers
{
    ...
    {
        /// <summary>
        /// Represents a token of from the output of the char->token step as a linked list element
        /// and facilitates the merging process.
        /// </summary>
        struct Symbol
        {
            /// <summary>
            ...
            /// <summary>
            /// Tells whether this symbol is discarded, meaning that it shouldn't be used anymore.
            /// </summary>
