...
partial class CPUBackend
{
    ...
    internal unsafe struct RoiAlignJob : IParallelForBatch, IJobResourceDeclarationXSBO
    {
        ...
        void RoiAlignAvg(int i, int count)
        {
            ...
            float roiStartW = Sp[0] * spatialScale - roiOffset;
            float roiStartH = Sp[1] * spatialScale - roiOffset;
            float roiEndW = Sp[2] * spatialScale - roiOffset;
            float roiEndH = Sp[3] * spatialScale - roiOffset;
            ...
            while (count > 0)
            {
                ...
                if (count > 0)
                {
                    ...
                    if (oc == inputChannels)
                    {
                        ...
                        roiStartW = Sp[0] * spatialScale - roiOffset;
                        roiStartH = Sp[1] * spatialScale - roiOffset;
                        roiEndW = Sp[2] * spatialScale - roiOffset;
                        roiEndH = Sp[3] * spatialScale - roiOffset;
